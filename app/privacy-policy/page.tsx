		...
		<div className='p-4 md:px-36 lg:px-60 xl:px-80'>
			<div className='bg-orange-100 p-8'>
				...
				<p>
					...
					explains what personal data we collect from you and how we
					use it.
				</p>
				...
				<p>
					We use Google AdSense to display ads on our website. Google
					may collect information about your device, browsing
					activity, and interactions with ads for the purpose of
				...
				<p>
					...
					regarding your personal information. Please consult your
					local privacy laws to understand these rights.
				</p>
