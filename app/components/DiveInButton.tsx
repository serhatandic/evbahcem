...
const DiveInButton = () => {
	return (
		<div className='flex justify-between gap-4'>
			<Link
				className=' h-24 w-6/12 bg-orange-100 rounded-3xl text-md  mt-16 font-semibold flex flex-col justify-start pl-5 pt-2'
				href='/hastaliklar'
			>
				...
				<p className='text-xs font-light hidden lg:block'>
