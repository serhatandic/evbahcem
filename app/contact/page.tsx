		...
		<div className='p-4 md:px-36 lg:px-60 xl:px-80'>
			<div className='bg-orange-100 p-8'>
				...
				<p>
					...
					about camping, an article suggestion, or anything else, feel
					free to reach out. Here are the ways you can contact us:
				</p>
				...
				<ul>
					...
					<li>
						<strong>Can I suggest a topic for an article?</strong>
						<ul>
							<li>
					...
					<li>
						<strong>How can I contribute to your website?</strong>
						<ul>
							<li>
