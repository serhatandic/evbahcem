		...
		<div className='p-8 md:px-36 lg:px-60 xl:px-80'>
			<div className='bg-orange-100 p-8'>
				...
				<p>
					...
					the CampingAtWild.com website.
				</p>
				<p>
					Your access to and use of the Website is conditioned upon
				...
				<p>
					This Website is owned and operated by Archibald Whitney. The
					content, including but not limited to articles, images, and
					other materials, is the property of Archibald Whitney unless
					otherwise specified.
				</p>

				<h3 className='text-lg font-semibold'>1.2 Age Requirement</h3>
				<p>There is no age requirement</p>

				<h2 className='text-lg font-bold'>2. User Responsibilities</h2>

				<h3 className='text-lg font-semibold'>2.1 Acceptable Use</h3>
				<p>
					You agree not to use the Website in any way that is illegal,
				...
				<p>
					You may not copy, reproduce, or distribute content from this
					Website without explicit permission from the owner.
				</p>
				...
				<p>
					Under no circumstances will Archibald Whitney be liable for
					any consequential, incidental, or special damages arising
				...
				<p>
					...
					these Terms at any time. Changes will be posted on this page
					and your continued use of the Website indicates acceptance
					of the updated Terms.
				</p>

				<h2 className='text-lg font-bold'>8. Contact Information</h2>
				<p>
				...
				<ul>
					<li>
						...
						<ul>
							<li>
								If you violate any of these Terms, your access
								to the Website may be suspended or terminated.
							</li>
						</ul>
					</li>
					<li>
						...
						<ul>
							<li>
								The Terms are subject to change and any updates
					...
					<li>
						...
						<ul>
							<li>
								The content on this Website is copyrighted and
								cannot be used without explicit permission from
								the owner.
							</li>
						</ul>
					</li>
